...
var taskInput=document.querySelector(".add-item__input-text");//Add a new task.
...
var createNewTaskElement=function(taskString){
    ...
    label.className="todo__label label";

    //Each elements, needs appending
    checkBox.type="checkbox";
    checkBox.className="todo__input-checkbox input-checkbox";
    editInput.type="text";
    editInput.className="todo__input-text input-text";

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.className="todo__btn btn btn_edit";

    deleteButton.className="todo__btn btn btn_delete";
    deleteButtonImg.src="./remove.svg";
    deleteButtonImg.className="todo__btn-img btn-img";
...
var addTask=function(){
    ...
    //Create a new list item with the text from the .add-item__input-text:
